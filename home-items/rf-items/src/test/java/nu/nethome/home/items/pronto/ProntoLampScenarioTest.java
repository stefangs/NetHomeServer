...
import nu.nethome.coders.decoders.ProntoDecoder;
...
public class ProntoLampScenarioTest {
    ...
    public void onCommand() throws BadMessageException {
        ...
        assertThat(player.getMessageFieldString(0, "Message"), is(sonyMessage1));
    }
}
