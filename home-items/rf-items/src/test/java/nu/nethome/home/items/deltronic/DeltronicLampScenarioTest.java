...
import nu.nethome.coders.decoders.DeltronicDecoder;
...
public class DeltronicLampScenarioTest {
    ...
    public void setUp() throws Exception {
        ...
        decoder = new DeltronicDecoder();
        lamp = new DeltronicLamp();
    ...
    public void onCommand() throws BadMessageException {
        ...
        assertThat(player.getMessageField(0, "Address"), is(5));
